...
function Silences:CreateElement_SilenceFrame(event, plate)
	...
	sp.SilenceFrame:SetSize(36, 36)
	sp.SilenceFrame:SetPoint("TOPRIGHT", sp, 31, -5)

    sp.SilenceFrame.tex = sp.SilenceFrame:CreateTexture()
    sp.SilenceFrame.tex:SetAllPoints()

    SP:AddSPBorders(sp.SilenceFrame, 1)

    sp.SilenceFrame.cd = CreateFrame("Cooldown", nil, sp.SilenceFrame, "CooldownFrameTemplate")
